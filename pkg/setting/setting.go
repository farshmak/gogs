...
import (
	...
	"github.com/farshmak/go-libravatar"
...
func getOpenSSHVersion() string {
	...
	// Trim unused information: https://github.com/farshmak/gogs/issues/4507#issuecomment-305150441
...
func NewContext() {
	...
	// Windows server and OpenSSH version lower than 5.1 (https://github.com/farshmak/gogs/issues/4507)
...
func newSessionService() {
	...
	SessionConfig.CookieName = Cfg.Section("session").Key("COOKIE_NAME").MustString("i_like_farshmak")
