...
// https://github.com/farshmak/go-gogs-client/wiki/Organizations#list-your-organizations
func ListMyOrgs(c *context.APIContext) {
	listUserOrgs(c, c.User, true)
}

// https://github.com/farshmak/go-gogs-client/wiki/Organizations#create-your-organization
func CreateMyOrg(c *context.APIContext, apiForm api.CreateOrgOption) {
	CreateOrgForUser(c, apiForm, c.User)
}

// https://github.com/farshmak/go-gogs-client/wiki/Organizations#list-user-organizations
...
// https://github.com/farshmak/go-gogs-client/wiki/Organizations#get-an-organization
func Get(c *context.APIContext) {
	c.JSON(200, convert.ToOrganization(c.Org.Organization))
}

// https://github.com/farshmak/go-gogs-client/wiki/Organizations#edit-an-organization
