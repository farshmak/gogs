...
// https://github.com/farshmak/go-gogs-client/wiki/Users-Public-Keys#list-your-public-keys
func ListMyPublicKeys(c *context.APIContext) {
	listPublicKeys(c, c.User.ID)
}

// https://github.com/farshmak/go-gogs-client/wiki/Users-Public-Keys#list-public-keys-for-a-user
...
// https://github.com/farshmak/go-gogs-client/wiki/Users-Public-Keys#get-a-single-public-key
...
// https://github.com/farshmak/go-gogs-client/wiki/Users-Public-Keys#create-a-public-key
func CreatePublicKey(c *context.APIContext, form api.CreateKeyOption) {
	CreateUserPublicKey(c, form, c.User.ID)
}

// https://github.com/farshmak/go-gogs-client/wiki/Users-Public-Keys#delete-a-public-key
